...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Provider.of<HomeProvider>(context, listen: false).home();
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor:
          AppColors.surface, // App body background matching --surface
...
class _HomeHeaderDelegate extends SliverPersistentHeaderDelegate {
  ...
  _HomeHeaderDelegate({required this.topPadding, required this.greeting});
...
Widget _buildBentoCard(
  ...
  return Container(
    ...
    decoration: BoxDecoration(
      ...
      boxShadow:
          [AppColors.ink.withOpacity(0.06), AppColors.ink.withOpacity(0.04)]
              .map(
                (c) => BoxShadow(
                  color: c,
                  blurRadius: 3,
